...
export default function Header({ email, name, avatarUrl, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between gap-4 border-b border-slate-200 bg-white px-4 sm:px-6 shadow-sm">
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        {avatarUrl ? (
          ...
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-brand-600 text-sm font-bold text-white ring-2 ring-brand-100">
            {initials}
          </div>
        )}
      </div>
