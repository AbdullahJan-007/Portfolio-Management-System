...
export default function PreviewPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-white p-8 shadow-sm">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="flex items-start gap-5">
            {profile?.avatarUrl ? (
              ...
              <div className="grid h-20 w-20 shrink-0 place-items-center rounded-2xl bg-brand-600 text-2xl font-bold text-white ring-4 ring-white shadow-md">
